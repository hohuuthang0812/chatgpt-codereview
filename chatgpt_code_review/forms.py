...
class RepoForm:
    ...
    def display_form(self):
        ...
        language_values = [lang[1] for lang in language_options]
        ...
        self.lang = language_values[language_names.index(selected_language_index)]

        self.extensions = st.multiselect(
            # "File extensions to analyze",
            "Các định dạng tệp cần phân tích",
...
class AnalyzeFilesForm:
    ...
    def display_form(self):
        ...
        st.write("Chọn các tệp để phân tích:")
